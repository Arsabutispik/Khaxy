...
export async function logConfig(interaction: ChatInputCommandInteraction<"cached">, guildData: GuildWithLogs) {
  ...
  switch (messageComponent.values[0]) {
    case "messageLogsChannelId":
      ...
      await dynamicChannel("messageLogsChannelId", messageComponent, guildData, t);
      break;
    case "guildMemberLogsChannelId":
      ...
      await dynamicChannel("guildMemberLogsChannelId", messageComponent, guildData, t);
      break;
    case "guildLogsChannelId":
      ...
      await dynamicChannel("guildLogsChannelId", messageComponent, guildData, t);
      break;
    case "voiceLogsChannelId":
      ...
      await dynamicChannel("voiceLogsChannelId", messageComponent, guildData, t);
      break;
    case "channelLogsChannelId":
      ...
      await dynamicChannel("channelLogsChannelId", messageComponent, guildData, t);
      break;
    case "emojiLogsChannelId":
      ...
      await dynamicChannel("emojiLogsChannelId", messageComponent, guildData, t);
      break;
    case "roleLogsChannelId":
      ...
      await dynamicChannel("roleLogsChannelId", messageComponent, guildData, t);
      break;
    case "stickerLogsChannelId":
      ...
      await dynamicChannel("stickerLogsChannelId", messageComponent, guildData, t);
      break;
    case "eventLogsChannelId":
      ...
      await dynamicChannel("eventLogsChannelId", messageComponent, guildData, t);
      break;
    case "inviteLogsChannelId":
      ...
      await dynamicChannel("inviteLogsChannelId", messageComponent, guildData, t);
      break;
    case "pollLogsChannelId":
      ...
      await dynamicChannel("pollLogsChannelId", messageComponent, guildData, t);
      break;
    case "stageLogsChannelId":
      ...
      await dynamicChannel("stageLogsChannelId", messageComponent, guildData, t);
      break;
    case "soundboardLogsChannelId":
      ...
      await dynamicChannel("soundboardLogsChannelId", messageComponent, guildData, t);
      break;
    case "threadLogsChannelId":
      ...
      await dynamicChannel("threadLogsChannelId", messageComponent, guildData, t);
      break;
    case "webhookLogsChannelId":
      ...
      await dynamicChannel("webhookLogsChannelId", messageComponent, guildData, t);
      break;
  }
}
