import { infractionAddParameters } from "../../@types/types";

export async function addInfraction(p: infractionAddParameters) {
...
export async function editInfraction(p: infractionAddParameters & { caseNumber: number }) {
