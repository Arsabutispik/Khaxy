      ...
      await modlog(
        {
          ...
          reason: client.handleLanguages("KICK_EVENT_NO_EXECUTOR", client, member.guild.id),
        },
        client,
      );
      return;
    ...
    await modlog(
      {
        ...
        reason: reason || client.handleLanguages("KICK_EVENT_NO_REASON", client, member.guild.id),
      },
      client,
    );
  }
