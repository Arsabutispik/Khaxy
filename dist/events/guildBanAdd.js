...
export default async (client, ban) => {
    ...
    if (!ban.guild.members.me.permissions.has("ViewAuditLog")) {
        await modlog({ guild: ban.guild, user: ban.user, action: "BAN", actionmaker: client.user, reason: "Kimin olduğunu öğrenmek için yeterliye yetkiye sahip değilim." }, client);
        return;
    }
