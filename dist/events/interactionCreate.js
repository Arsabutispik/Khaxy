...
export default async (client, interaction) => {
    if (interaction.isButton()) {
        if (interaction.customId === "modMailReply") {
            ...
            if (!data)
                return interaction.reply({ content: "This is not a modmail channel!", ephemeral: true });
            ...
            if (!data)
                return interaction.reply({ content: "You don't have an open modmail", ephemeral: true });
    ...
    if (interaction.isChatInputCommand()) {
        if (interaction.channel.type === ChannelType.DM)
            return interaction.reply({ content: "Slash command unavailable in DMs!", ephemeral: true });
